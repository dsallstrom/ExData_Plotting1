...
plot(dta$DateTime, dta$Voltage, ylab="Voltage", xlab="datetime", type="l")
plot(dta$DateTime, dta$Global_reactive_power, ylab="Global_reactive_power", xlab="datetime", type="l")
dev.off()